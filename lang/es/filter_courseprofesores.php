...
$string['lastaccess'] = 'Última conexión: hace {$a}';
...
$string['showonlinestatus'] = 'Mostrar estado en línea';
$string['showonlinestatus_desc'] = 'Mostrar si el profesor está en línea ahora o la hora de su último acceso al curso.';
...
$string['unreadmessages_received'] = 'Mensajes no leídos de este profesor';
